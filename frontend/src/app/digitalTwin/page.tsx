    ...
    <div className="px-10 flex flex-col gap-2 bg-[#c3ebfa] rounded-lg w-7/9 h-full">
      ...
      >
        <Card className=" bg-cyan-950">
          <div
            id="btn_duration"
            className="flex gap-4 justify-end items-center px-4 py-4"
          >
            <Select
              ...
              radius={'full'}
              color={'default'}
              defaultSelectedKeys={['threeDays']}
            >
              <SelectItem key={''} value={''}>
                {' '}
                24 hours{' '}
              </SelectItem>
              <SelectItem key={'threeDays'} value={''}>
                {' '}
                3 days{' '}
              </SelectItem>
              <SelectItem key={''} value={''}>
          ...
          <div
            id="param_illumination"
            className="flex px-2 py-2 gap-2 grid-cols-2"
          >
            <div className="w-[13vw] items-center pl-2">
              <LatestValueBox
                tooltipTitle={'What is Maintained Average Illuminance?'}
                tooltipContent={
                  'Illuminance level lighting installations aim to provide'
                }
            ...
            <div className="w-[70vw] px-2 flex flex-col gap-[1vh]">
              <Card className="bg-cyan-900">
                <CardBody>
                  <LineChart
                    data={sampleData}
                    categoryKey="illuminance"
                    metricKey="maintainedAverage"
                  ></LineChart>
                </CardBody>
              </Card>
            </div>
          ...
          >
            <div className="w-[13vw] items-center pl-2">
              <LatestValueBox
                ...
                tooltipContent={
                  'Ratio of minimum to average or maximum illuminance'
                }
          ...
          <div id="param_glare" className="flex px-2 py-2 gap-2 grid-cols-2">
            <div className="w-[13vw] items-center pl-2">
              <LatestValueBox
                ...
                tooltipContent={
                  'Unified Glare Rating (UGR) - Numerical measure of glare in a particular environment'
                }
          ...
          >
            <div className="w-[13vw] items-center px-2">
              <LatestValueBox
                ...
                tooltipContent={
                  "Measure of light source's ability to reveal colors accurately"
                }
          ...
          >
            <div className="w-[13vw] items-center pl-2">
              <LatestValueBox
                ...
                tooltipContent={
                  'Deviation from the black-body line in color space'
                }
          ...
          <div id="flicker" className="flex px-2 py-2 gap-2 grid-cols-2">
            <div className="w-[13vw] items-center px-2">
              <LatestValueBox
                ...
                tooltipContent={
                  'Stroboscopic Visibility Measure (SVM) - Measure of visibility of stroboscopic effects'
                }
          ...
          <div
            id="phot_safety"
            className="flex px-2 py-2 pb-5 gap-2 grid-cols-2"
          >
            <div className="w-[13vw] items-center px-2">
              <LatestValueBox
            ...
            <div className="w-[70vw] px-2">
              <Card className="bg-cyan-900">
                <CardBody>
                  <LineChart
                    data={sampleData}
                    categoryKey="photobiologicalSafety"
                    metricKey="UV"
                  ></LineChart>
                </CardBody>
              </Card>
