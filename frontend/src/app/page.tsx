...
import AddTwin from './components/AddTwin/AddTwin'
  ...
  return (
    <>
      <div className="flex flex-col">
        <div
          className="flex flex-col gap-4 bg-slate-300 p-7 rounded-lg"
          style={{
            marginLeft: '50px',
            marginTop: '50px',
            marginRight: '60px',
        ...
        <div className="flex flex-col" style={{ marginLeft: '50px' }}>
          {filteredAssets.map(asset => {
            const twinData = digitaltwindata.DigitalTwins.find(
              dt => dt.assetId === asset.uid
            )
            return twinData ? (
              <DigitalTwin
                key={asset.uid}
