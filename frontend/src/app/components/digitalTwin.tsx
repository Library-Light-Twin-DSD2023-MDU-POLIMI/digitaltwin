...
const DigitalTwin: React.FC<AssetProps> = ({asset, digitalTwin}) => {
  ...
  return (
    <><Card style={{ background: '#E8E8E8', marginBottom: '30px', marginRight: '50px' }}>
      <CardBody>
        <div style={{ display: 'flex', flexDirection: 'column', marginBottom: '10px' }}>
          <h6 className="text-2xl leading-tight">{asset.location.area} Area - {asset.location.section}</h6>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px' }}>
            ...
            <var className="text-center">{digitalTwin.illuminance.uniformityRatio}</var>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px' }}>
            ...
            <var className="text-center">{digitalTwin.colorRendering.CRI}</var>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px' }}>
            ...
            <var className="text-center">{digitalTwin.colorTemperature.Duv}</var>
            <Chip color="warning" variant="dot">
              Color Temperature
            </Chip>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px' }}>
          <p style={{color: '#E8E8E8'}} >.</p>
          <var className="text-center">{digitalTwin.colorPreference.PVF}</var>
            <Chip color="warning" variant="dot">
              Color Preference
            </Chip>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px' }}>
            <p style={{color: '#E8E8E8'}} >.</p>
            <var className="text-center">{digitalTwin.photobiologicalSafety.UV}</var>
            <Chip color="warning" variant="dot">
